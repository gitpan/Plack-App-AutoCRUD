package Plack::App::AutoCRUD::ConfigDomain;
use strict;
use warnings;
...
The L<Plack::App::AutoCRUD> application uses this domain at startup time
...
L<Plack::App::AutoCRUD::Controller::Table> to decide how many
